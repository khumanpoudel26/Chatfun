...
userRoutes.put('/update-profile', isAuthenticated, uploadProfile.single('profile'), user.UpdateProfile);
userRoutes.patch('/change-password', isAuthenticated, rateLimiter(20,90), user.ChangePassword);
